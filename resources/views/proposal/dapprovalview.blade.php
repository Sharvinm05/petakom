              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Dean Approval Status</label>
                      @if ($proposal->deanstatus == 2)
                          <p>Rejected</p>
                      @elseif ($proposal->deanstatus == 1)
                          <p>Approved</p>
                      @else 
                      <form action="{{ route('storedeanstatus') }}" method="post">
                        @csrf
                        <div class="form-group clearfix pt-2">
                          <input type="hidden" name="id" value="{{ $proposal->id }}">
                          <div class="icheck-primary d-inline pr-5">
                            <input type="radio" id="radioPrimary1" name="deanstatus" value="1" checked>
                            <label for="radioPrimary1">
                              Approve
                            </label>
                          </div>
                          <div class="icheck-primary d-inline">
                            <input type="radio" id="radioPrimary2" name="deanstatus" value="2">
            ...
            <!-- /.card-body -->
              ...
              <div class="card-footer">
                <div>
                  ...
                  <a class="btn btn-secondary float-right" href="/dean/proposal/approval">Back</a>
                </div>
              </div>
          </div>
          <!-- /.card -->
